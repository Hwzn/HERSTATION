...
class BuildSubscribeBody extends StatefulWidget {
  ...
  @override
  State<BuildSubscribeBody> createState() => _BuildSubscribeBody();
}

class _BuildSubscribeBody extends State<BuildSubscribeBody> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          MyText(
              title: widget.subscriptionModel.desc ?? "",
