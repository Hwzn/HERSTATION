...
class BuildItemNewService extends StatelessWidget {
  ...
  BuildItemNewService({super.key, required this.servicesData});

  @override
  Widget build(BuildContext context) {
    double width = (MediaQuery.of(context).size.width / 2) - 30;
    return
     Container(margin: const EdgeInsets.symmetric(horizontal: 5),child:  Column(
       ...
       children: [
         ...
         GenericTextField(
           ...
           controller: servicesData.serviceName,
