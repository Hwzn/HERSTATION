                ...
                Row(
                  ...
                  children: [
                    ...
                    InkWell(
                      ...
                      onTap: () =>
                          widget.appointmentDetailsData.closeDialog(context),
                    ),
                  ],
                ),
                BlocBuilder<GenericBloc<bool>, GenericState<bool>>(
                    bloc: widget.appointmentDetailsData.payReceiptCubit,
                    builder: (context, state) {
                      return GestureDetector(
                        ...
                        onTap: () =>
                            widget.appointmentDetailsData.chooseReceipt(),
                      );
                    }),
                BlocBuilder<GenericBloc<bool>, GenericState<bool>>(
                    bloc: widget.appointmentDetailsData.payVisaCubit,
                    builder: (context, state) {
                      return GestureDetector(
                        onTap: () =>
                            widget.appointmentDetailsData.chooseOnline(),
                        child: Container(
                          decoration: BoxDecoration(
                              color: state.data
                                  ? MyColors.primary
            ...
            children: [
              SizedBox(
                ...
                child: LoadingButton(
                  ...
                  onTap: () {
                    if (widget
                        .appointmentDetailsData.payReceiptCubit.state.data) {
                      widget.appointmentDetailsData
                          .executePay(widget.orderID, context);
                    } else {
                      LoadingDialog.showLoadingDialog();

                      configureSDK(widget.amount.toString());
                      // configureSDK("5");
                      startSDK().then((value) {
                        if (sdkStatus == "SUCCESS") {
                          widget.appointmentDetailsData.addTransaction(
                            context,
                            widget.amount,
                            widget.orderID,
                            transactionId!,
                            transactionType == "VISA" ? "visa" : "apple_pay",
                          );
                        } else {}
                      });
                    }
                  ...
                  btnKey: widget.appointmentDetailsData.btnCancelKey,
                  fontSize: 13,
                ),
              ),
              InkWell(
