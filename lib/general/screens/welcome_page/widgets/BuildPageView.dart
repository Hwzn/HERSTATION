...
class BuildPageView extends StatelessWidget {
  ...
  final double numberCircle;

  const BuildPageView(
      {Key? key, required this.model, required this.welcomePageData, required this.numberCircle})
      : super(key: key);
    ...
    return Stack(
      children: [
        ...
        SizedBox(
          ...
          //     image: CachedImage(url: model.image ?? ""),
          //     fit: BoxFit.fill,
          //   ),
          // ),
          child: Container(
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                        ...
                        child: CircleProgressBar(
                            ...
                            value: (model.index! + 1) * numberCircle,
                            strokeWidth: 2.5,
                            child: Container(
